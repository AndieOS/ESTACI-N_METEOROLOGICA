...
def update_gauges_graphs(_):
    ...
    for variable, props in variables.items():
        ...
        if variable == 'temperaturaaire':
            if last_value <  25:  # Ejemplo de valor alto
                color = props['colors']['warning']
            elif last_value > 25:  # Ejemplo de valor extremo
            ...
            if last_value < 80:  # Ejemplo de valor alto
                color = props['colors']['warning']
            elif last_value > 80:  # Ejemplo de valor extremo
                color = props['colors']['danger']
            else:
                color = props['colors']['normal']
        elif variable == 'intensidadluz':
            if last_value < 50000:  # Ejemplo de valor alto
                color = props['colors']['warning']
            elif last_value > 50000:  # Ejemplo de valor extremo
                color = props['colors']['danger']
            else:
                color = props['colors']['normal']
        elif variable == 'indiceuv':
            if last_value < 6:  # Ejemplo de valor alto
                color = props['colors']['warning']
            elif last_value > 6:  # Ejemplo de valor extremo
                color = props['colors']['danger']
            else:
                color = props['colors']['normal'] 
        elif variable == 'velocidadviento':
            if last_value < 5:  # Ejemplo de valor alto
                color = props['colors']['warning']
            elif last_value > 5:  # Ejemplo de valor extremo
                color = props['colors']['danger']
            else:
                color = props['colors']['normal'] 
        elif variable == 'cantidadlluvia':
            if last_value < 20:  # Ejemplo de valor alto
                color = props['colors']['warning']
            elif last_value > 20:  # Ejemplo de valor extremo
                color = props['colors']['danger']
            else:
                color = props['colors']['normal'] 
